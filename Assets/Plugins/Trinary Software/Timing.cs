...
namespace MEC
{
    public class Timing : MonoBehaviour
    {
        ...
        /// </summary>
        [System.NonSerialized] public float localTime;
        ...
        public static CoroutineHandle RunCoroutine(IEnumerator<float> coroutine, GameObject gameObj)
        {
            return coroutine == null
                ...
                : Instance.RunCoroutineInternal(coroutine, Segment.Update,
                    gameObj == null ? (int?)null : gameObj.GetInstanceID(), null,
                    new CoroutineHandle(Instance._instanceID), true);
        }
        ...
        public static CoroutineHandle RunCoroutine(IEnumerator<float> coroutine, GameObject gameObj, string tag)
        {
            return coroutine == null
                ? new CoroutineHandle()
                : Instance.RunCoroutineInternal(coroutine, Segment.Update,
                    gameObj == null ? (int?)null : gameObj.GetInstanceID(), tag,
                    new CoroutineHandle(Instance._instanceID), true);
        }
        ...
        public static CoroutineHandle RunCoroutine(IEnumerator<float> coroutine, Segment segment)
        {
            return coroutine == null
                ? new CoroutineHandle()
                : Instance.RunCoroutineInternal(coroutine, segment, null, null,
                    new CoroutineHandle(Instance._instanceID), true);
        }
        ...
        public static CoroutineHandle RunCoroutine(IEnumerator<float> coroutine, Segment segment, string tag)
        {
            return coroutine == null
                ? new CoroutineHandle()
                : Instance.RunCoroutineInternal(coroutine, segment, null, tag,
                    new CoroutineHandle(Instance._instanceID), true);
        }
        ...
        public static CoroutineHandle RunCoroutine(IEnumerator<float> coroutine, Segment segment, int layer, string tag)
        {
            return coroutine == null
                ? new CoroutineHandle()
                : Instance.RunCoroutineInternal(coroutine, segment, layer, tag,
                    new CoroutineHandle(Instance._instanceID), true);
        }
        ...
        public CoroutineHandle RunCoroutineOnInstance(IEnumerator<float> coroutine, GameObject gameObj)
        {
            return coroutine == null
                ...
                : RunCoroutineInternal(coroutine, Segment.Update,
                    gameObj == null ? (int?)null : gameObj.GetInstanceID(), null, new CoroutineHandle(_instanceID),
                    true);
        }
        ...
        public CoroutineHandle RunCoroutineOnInstance(IEnumerator<float> coroutine, GameObject gameObj, string tag)
        {
            return coroutine == null
                ? new CoroutineHandle()
                : RunCoroutineInternal(coroutine, Segment.Update,
                    gameObj == null ? (int?)null : gameObj.GetInstanceID(), tag, new CoroutineHandle(_instanceID),
                    true);
        }
            ...
            SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (IsRunning(handle))
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle = Instance.RunCoroutineInternal(coroutine, Segment.Update, null,
                        null,
            ...
            SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (Instance._layeredProcesses.ContainsKey(layer))
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle = Instance.RunCoroutineInternal(coroutine, Segment.Update, layer,
                        null,
                        new CoroutineHandle(Instance._instanceID), false);
            ...
            SingletonBehavior behaviorOnCollision)
        {
            ...
            if (behaviorOnCollision == SingletonBehavior.Wait)
            {
                ...
                if (matches.Count > 0)
                {
                    CoroutineHandle newCoroutineHandle = _instance.RunCoroutineInternal(coroutine, Segment.Update,
                        layer, tag,
            ...
            SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (_handleToIndex.ContainsKey(handle) && !CoindexIsNull(_handleToIndex[handle]))
            {
                ...
                if (behaviorOnCollision == SingletonBehavior.Wait)
                {
                    CoroutineHandle newCoroutineHandle = RunCoroutineInternal(coroutine, Segment.Update, null, null,
            ...
            SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (_layeredProcesses.ContainsKey(layer))
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle = RunCoroutineInternal(coroutine, Segment.Update, layer, null,
                        new CoroutineHandle(_instanceID), false);
            ...
            SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (_taggedProcesses.ContainsKey(tag))
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle = RunCoroutineInternal(coroutine, Segment.Update, null, tag,
                        new CoroutineHandle(_instanceID), false);
            ...
            SingletonBehavior behaviorOnCollision)
        {
            ...
            if (behaviorOnCollision == SingletonBehavior.Wait)
            {
                ...
                if (matches.Count > 0)
                {
                    CoroutineHandle newCoroutineHandle = RunCoroutineInternal(coroutine, Segment.Update, layer, tag,
                        new CoroutineHandle(_instanceID), false);
                    WaitForOtherHandles(newCoroutineHandle, matches, false);
                    return newCoroutineHandle;
                }
            ...
            SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (_layeredProcesses.ContainsKey(layer))
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle = RunCoroutineInternal(coroutine, segment, layer, null,
                        new CoroutineHandle(_instanceID), false);
                    WaitForOtherHandles(newCoroutineHandle, _layeredProcesses[layer], false);
                    return newCoroutineHandle;
                }
            ...
            string tag, SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (_taggedProcesses.ContainsKey(tag))
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle = RunCoroutineInternal(coroutine, segment, null, tag,
                        new CoroutineHandle(_instanceID), false);
                    WaitForOtherHandles(newCoroutineHandle, _taggedProcesses[tag], false);
                    return newCoroutineHandle;
                }
            ...
            SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (behaviorOnCollision == SingletonBehavior.Wait)
            {
                ...
                if (matches.Count > 0)
                {
                    CoroutineHandle newCoroutineHandle = RunCoroutineInternal(coroutine, segment, layer, tag,
                        new CoroutineHandle(_instanceID), false);
                    WaitForOtherHandles(newCoroutineHandle, matches, false);
                    return newCoroutineHandle;
                }
                ...
                switch (segment)
                {
                    ...
                    case Segment.FixedUpdate:
                        ...
                        if (_nextFixedUpdateProcessSlot >= FixedUpdateProcesses.Length)
                        {
                            ...
                            FixedUpdateProcesses = new IEnumerator<float>[FixedUpdateProcesses.Length +
                                                                          (ProcessArrayChunkSize * _expansions++)];
                    ...
                    case Segment.LateUpdate:
                        ...
                        if (_nextLateUpdateProcessSlot >= LateUpdateProcesses.Length)
                        {
                            ...
                            LateUpdateProcesses = new IEnumerator<float>[LateUpdateProcesses.Length +
                                                                         (ProcessArrayChunkSize * _expansions++)];
                    ...
                    case Segment.SlowUpdate:
                        ...
                        if (_nextSlowUpdateProcessSlot >= SlowUpdateProcesses.Length)
                        {
                            ...
                            SlowUpdateProcesses = new IEnumerator<float>[SlowUpdateProcesses.Length +
                                                                         (ProcessArrayChunkSize * _expansions++)];
                    ...
                    case Segment.EndOfFrame:
                        ...
                        if (_nextEndOfFrameProcessSlot >= EndOfFrameProcesses.Length)
                        {
                            ...
                            EndOfFrameProcesses = new IEnumerator<float>[EndOfFrameProcesses.Length +
                                                                         (ProcessArrayChunkSize * _expansions++)];
        ...
        private bool UpdateTimeValues(Segment segment)
        {
            switch (segment)
            {
                ...
                case Segment.ManualTimeframe:
                    float timeCalculated = SetManualTimeframeTime == null
                        ? Time.time
        ...
        public static bool SetSegment(CoroutineHandle handle, Segment newSegment)
        {
            ...
            inst.RunCoroutineInternal(inst.CoindexExtract(inst._handleToIndex[handle]), newSegment,
                inst._processLayers.ContainsKey(handle)
                    ? inst._processLayers[handle]
                    : (int?)null, inst._processTags.ContainsKey(handle)
                    ? inst._processTags[handle]
                    : null, handle, false);
        ...
        private static IEnumerator<float> SwitchCoroutineRepS(IEnumerator<float> coptr, CoroutineHandle handle)
        {
            ...
            instance.RunCoroutineInternal(coptr, _tmpSegment,
                instance._processLayers.ContainsKey(handle) ? instance._processLayers[handle] : (int?)null,
        ...
        private static IEnumerator<float> SwitchCoroutineRepST(IEnumerator<float> coptr, CoroutineHandle handle)
        {
            ...
            instance.RunCoroutineInternal(coptr, _tmpSegment,
                instance._processLayers.ContainsKey(handle) ? instance._processLayers[handle] : (int?)null,
                _tmpRef as string, handle, false);
            return null;
        }
        ...
        {
            CoroutineHandle handle = action == null
                ? new CoroutineHandle()
    ...
    public struct CoroutineHandle : System.IEquatable<CoroutineHandle>
    {
        ...
        public override string ToString()
        {
            ...
            else
            {
                if (Timing.GetLayer(this) == null)
                    ...
                    return Timing.GetDebugName(this) + " Tag: " + Timing.GetTag(this) + " Layer: " +
        ...
        public bool IsRunning
        {
            ...
            set
            {
                if (!value) Timing.KillCoroutines(this);
            }
        }
        ...
        public bool IsPaused
        {
            ...
            set
            {
                if (value) Timing.PauseCoroutines(this);
                else Timing.ResumeCoroutines(this);
            }
        }
